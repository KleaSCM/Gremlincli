...
pub fn run() {
    let splash_art = load_ascii("ascii/TypeScriptGremlin.txt");
    println!("{}", splash_art.bright_magenta());
    println!("\n{}", "⚛️ TypeScript Project Builder ⚛️".bright_purple().bold().blink());
    
    loop {
        println!("\n{}", "TypeScript Options:".bright_cyan());
        ...
        match input.trim() {
            "1" => println!("{}", "TypeScript project creation coming soon!".bright_yellow()),
            "2" => return,
