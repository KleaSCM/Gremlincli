...
pub fn run() {
    ...
    println!("\n{}", "💾 Disk and Storage Dashboard 💾".bright_purple().bold().blink());
    
    loop {
        println!("\n{}", "Disk Commands:".bright_cyan());
        command_matcher::show_commands_by_category(CommandCategory::DiskAndStorage);
